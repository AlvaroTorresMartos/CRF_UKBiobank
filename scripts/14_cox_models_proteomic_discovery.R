...
data = read_rds("/mnt/project/data/processed/discovery_population_proteomic_signature.RDS")
...
#             data = data_def)
# 
# cox = coxph(surv_obj ~ quantile_outcome  + sex +
#               townsend_q5 +  country + education_group + fruit_veg_rec + 
#               smoking_status + alc_group +  satfat_3  + bmi_group +
#                + menopause + medication_others + 
#               medication_cholesterol + medication_bp +
#               strata(ethnicity, cancer_fam),
#             data = data_def)
# 
# cox.zph(cox)
# 
